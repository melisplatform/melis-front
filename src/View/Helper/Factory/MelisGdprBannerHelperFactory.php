...
use MelisFront\View\Helper\MelisGdprBannerHelper;

class MelisGdprBannerHelperFactory implements FactoryInterface
{
	public function createService(ServiceLocatorInterface $sl)
	{
		...
		$helper = new MelisGdprBannerHelper($serviceLoc, $renderMode, $preview);
