...
use MelisFront\View\Helper\MelisMenuHelper;

class MelisMenuHelperFactory implements FactoryInterface
{
	public function createService(ServiceLocatorInterface $sl)
	{
		...
		$helper = new MelisMenuHelper($serviceLoc, $renderMode, $preview);
